...
public class ConstraintsHelper {
    ...
    public ConstraintsHelper(Context context, AttributeSet attrs, Preference pref) {
        ...
        TypedArray a = context.getResources().obtainAttributes(attrs,
                R.styleable.exthm_SelfRemovingPreference);
        mSummaryMinLines = a.getInteger(R.styleable.exthm_SelfRemovingPreference_minSummaryLines, -1);
        String replacesKey = a.getString(R.styleable.exthm_SelfRemovingPreference_replacesKey);
        if (replacesKey != null) {
    ...
    private boolean checkConstraints() {
        ...
        try {
            ...
            boolean rOwner = a.getBoolean(R.styleable.exthm_SelfRemovingPreference_requiresOwner, false);
            if (rOwner && UserHandle.myUserId() != UserHandle.USER_OWNER) {
                return false;
            }

            // Check if a specific package is installed
            String rPackage = a.getString(R.styleable.exthm_SelfRemovingPreference_requiresPackage);
            if (rPackage != null) {
            ...
            String rAction = a.getString(R.styleable.exthm_SelfRemovingPreference_requiresAction);
            if (rAction != null) {
            ...
            String rProperty = a.getString(R.styleable.exthm_SelfRemovingPreference_requiresProperty);
            if (rProperty != null) {
            ...
            TypedValue tv = a.peekValue(R.styleable.exthm_SelfRemovingPreference_requiresConfig);
            if (tv != null && tv.resourceId != 0) {
                if (tv.type == TypedValue.TYPE_STRING &&
                    ...
                    int mask = a.getInt(
                            R.styleable.exthm_SelfRemovingPreference_requiresConfigMask, -1);
